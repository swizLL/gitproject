			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<form method="post" class="form-horizontal" id="commentForm" action="<%=path %>/EmpServlet?method=doUpdateEmp&id=<%=employee.getId()%>">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									<input type="date" class="form-control" name="date" value="<%=employee.getBirthday() %>" >
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-8">
									...
									<a href="<%=path %>/EmpServlet?method=findEmpList" class="btn btn-info">取  消</a>
								</div>
							</div>
						</form>
					</div>
