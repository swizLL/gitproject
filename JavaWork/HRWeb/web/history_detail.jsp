        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <% History history = (History) request.getAttribute("his"); %>
                    <form method="post" class="form-horizontal" action="">
                        <div class="form-group">
                            <div class="col-md-1"></div>
                            <div class="col-md-4">
                                <label class="col-sm-8 control-label">工号：</label>
                                <p class="form-control-static"><%=history.getEmployee_number() %></p>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="form-control-static"><%=history.getBirthday() %></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-1"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="form-control-static"><%=history.getDepartment_number() %></p>
                            </div>
                            <div class="col-md-4">
                                <label class="col-sm-5 control-label">职称：</label>
                                <p class="form-control-static"><%=history.getPosition_number() %></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-1"></div>
                            <div class="col-md-4">
                                ...
                                <p class="form-control-static"><%=history.getIn_time() %></p>
                            </div>
                            <div class="col-md-4">
                                <label class="col-sm-8 control-label">离职时间：</label>

                                <p class="form-control-static"><%=history.getOut_time() %></p>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-8">
                                <a href="<%=path %>/HistoryServlet?method=findHisList" class="btn btn-info">返&nbsp;&nbsp;回</a>
                            </div>
                        </div>
                    </form>
                </div>
