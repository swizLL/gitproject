        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form method="post" class="form-horizontal" id="commentForm" action="<%=path %>/HistoryServlet?method=doUpdateHis&id=<%=history.getId()%>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">工号</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="employeeNumber" value="<%=history.getEmployee_number() %>" readonly="readonly">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-8">
                                ...
                                <a href="<%=path %>/HistoryServlet?method=findHisList" class="btn btn-info">取  消</a>
                            </div>
                        </div>
                    </form>
                </div>
