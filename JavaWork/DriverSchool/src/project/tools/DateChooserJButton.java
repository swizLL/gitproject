...
//如果这里要能够选择,会要判断很多东西,比如每个月分别由多少日,以及闰年问题.所以,就干脆把Enable设为false
            ...
            daySpin.setPreferredSize(new Dimension(40, 25));
            daySpin.setName("Day");
            ...
            hourSpin.setPreferredSize(new Dimension(40, 25));
            ...
            minuteSpin.setPreferredSize(new Dimension(40, 25));
            ...
            secondSpin.setPreferredSize(new Dimension(40, 25));
...
//根据格式设置内容yyyy/MM/dd HH
        mainFrame.add(new DateChooserJButton(new SimpleDateFormat("yyyy/MM/dd HH"), "2012/12/12 22"), java.awt.BorderLayout.CENTER);
